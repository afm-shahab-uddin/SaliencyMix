...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        if args.beta > 0 and r < args.cutmix_prob:
            ...
            bbx1, bby1, bbx2, bby2, tbbx1, tbby1, tbbx2, tbby2 = saliency_bbox(input[rand_index[0]], lam)
            input[:, :, tbbx1:tbbx2, tbby1:tbby2] = input[rand_index, :, bbx1:bbx2, bby1:bby2]
...
def saliency_bbox(img, lam):
    ...
    # Source patch size
    source_patch_width = bbx2 - bbx1
    source_patch_height = bby2 - bby1
    ...
    # Check possible patch width
    poss_width = W - cx
    poss_height = H - cy

    # Check whether the patch will accommodate or not
    if poss_width < source_patch_width:
        tbbx1 = cx - (source_patch_width - poss_width)
    else:
        tbbx1 = cx

    if poss_height < source_patch_height:
        tbby1 = cy - (source_patch_height - poss_height)
    else:
        tbby1 = cy

    tbbx2 = tbbx1 + source_patch_width
    tbby2 = tbby1 + source_patch_height

    return bbx1, bby1, bbx2, bby2, tbbx1, tbby1, tbbx2, tbby2
